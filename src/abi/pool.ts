...
export const functions = {
    ...
    globalState: new Func<[], {}, ([price: bigint, tick: number, fee: number, timepointIndex: number, timepointIndexSwap: number, communityFeeToken0: number, communityFeeToken1: number, unlocked: boolean] & {price: bigint, tick: number, fee: number, timepointIndex: number, timepointIndexSwap: number, communityFeeToken0: number, communityFeeToken1: number, unlocked: boolean})>(
        abi, '0xe76c01e4'
    ),
...
export class Contract extends ContractBase {
    ...
    globalState(): Promise<([price: bigint, tick: number, fee: number, timepointIndex: number, timepointIndexSwap: number, communityFeeToken0: number, communityFeeToken1: number, unlocked: boolean] & {price: bigint, tick: number, fee: number, timepointIndex: number, timepointIndexSwap: number, communityFeeToken0: number, communityFeeToken1: number, unlocked: boolean})> {
